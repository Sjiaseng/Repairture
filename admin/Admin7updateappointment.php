<?php
    try{
        ...
        if (mysqli_query($con, $sql)) {
            echo "<script> alert('Record Updated!'); window.location.href='Admin7_Cancelled_Appointment.php';</script>";
        }
        else{
            echo "<script> alert('Record Failed to Update!'); window.location.href='Admin7_Cancelled_Appointment.php';</script>";
        }
    }
