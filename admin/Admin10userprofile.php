...
<body>
    ...
    <form action="Admin10userprofileupdate.php" method="post" id="usereditform" enctype="multipart/form-data">
        ...
        <input type="password" name="user_passwrd" value="<?php echo $row["user_passwrd"]?>"> <br>

        <label>User Firstname:</label>
        <input type="text" name="user_firstname" value="<?php echo $row["user_firstname"]?>"> <br>

        <label>User Lastname:</label>
        <input type="text" name="user_lastname" value="<?php echo $row["user_lastname"]?>"> <br>

        <label>User Age: </label>
        <input type="text" name="user_age" value="<?php echo $row["user_age"]?>"> <br>
        ...
        <input type="text" name="usermobile_num" value="<?php echo $row["user_mobilenum"]?>" > <br>

        <label>User IC Number: </label>
        <input type="text" minlength="12" maxlength="12" name="useric_num" value="<?php echo $row["user_icnum"]?>"> <br>

        <label> Addressline:</label>
        <input type="text" name="user_addressline" value="<?php echo $row["user_addressline"]?>"> <br>

        <label>City:</label>
        <input type="text" name="user_city" value="<?php echo $row["user_city"]?>"> <br>

        <label>State:</label>
        <input type="text" name="user_state" value="<?php echo $row["user_state"]?>"> <br>

        <label>Poscode:</label>
        <input type="text" name="user_poscode" value="<?php echo $row["user_poscode"]?>"> <br>
