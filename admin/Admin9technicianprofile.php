...
<head>
    ...
    <title>Editing Technician</title>
</head>
<body>
    <?php
    ...
    <form action="Admin9technicianprofileupdate.php" method="post" id="technicianeditform" enctype="multipart/form-data">
        <input type="hidden" name="editingtechid" value="<?php echo $row["tech_ID"]; ?>">
        ...
        <input type="email" name="tech_email" value="<?php echo $row["tech_email"]?>"> <br>

        <label>Tech Password:</label>
        <input type="password" name="tech_passwrd" value="<?php echo $row["tech_passwrd"]?>"> <br>

        <label>Tech Firstname:</label>
        <input type="text" name="tech_firstname" value="<?php echo $row["tech_firstname"]?>"> <br>

        <label>Tech Lastname:</label>
        <input type="text" name="tech_lastname" value="<?php echo $row["tech_lastname"]?>"> <br>

        <label>Tech Age: </label>
        <input type="text" name="tech_age" value="<?php echo $row["tech_age"]?>"> <br>

        <label>Tech Gender:</label>
        <select name="techniciangender">
        ...
        <input type="text" name="techmobile_num" value="<?php echo $row["tech_mobilenum"]?>" > <br>

        <label>Tech IC Number: </label>
        <input type="text" minlength="12" maxlength="12" name="techic_num" value="<?php echo $row["tech_icnum"]?>"> <br>
        ...
        <input type="text" name="tech_location" value="<?php echo $row["service_location"]?>"> <br>

        <label> Addressline:</label>
        <input type="text" name="tech_addressline" value="<?php echo $row["tech_addressline"]?>"> <br>

        <label>City:</label>
        <input type="text" name="tech_city" value="<?php echo $row["tech_city"]?>"> <br>

        <label>State:</label>
        <input type="text" name="tech_state" value="<?php echo $row["tech_state"]?>"> <br>

        <label>Poscode:</label>
        <input type="text" name="tech_poscode" value="<?php echo $row["tech_poscode"]?>"> <br>
        ...
        <input type="submit" value="Save Changes" id="submittechedit">
